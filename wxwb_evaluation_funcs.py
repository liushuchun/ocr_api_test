...
def load_gt_res_json(myfile, flag):
    """
...
def main_evaluation(p, default_evaluation_params_fn, validate_data_fn, evaluate_method_fn, gt_file, show_result=True,
                    per_sample=True):
    """
